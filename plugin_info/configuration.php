...
<form class="form-horizontal">
  <fieldset>
    ...
    <div class="form-group">
      <label class="col-md-4 control-label">{{Trouver les équipments}}
        <sup><i class="fas fa-question-circle tooltips" title="{{Cliquer pour créer les équipements liés à ce compte}}"></i></sup>
      </label>
      <div class="col-md-4">
        <a class="btn btn-default" id="btSearchDevice"><i class='fa fa-refresh'></i> {{Créer les équipments}}</a>
      </div>
    </div>
  </fieldset>
</form>
...
<script>
    $('#btSearchDevice').on('click', function () {
        $.ajax({// fonction permettant de faire de l'ajax
            ...
            url: "plugins/DaikinResidentialCtrl/core/ajax/DaikinResidentialCtrl.ajax.php", // url du fichier php
            data: {
            ...
            $('#div_alert').showAlert({message: '{{Équipements ajoutés avec succès. Rafraichir la page pour les afficher.}}', level: 'success'});
          }
        });
    });
</script>
